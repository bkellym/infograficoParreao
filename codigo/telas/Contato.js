class TelaContato {
	...
	constructor() {
		...
		//this.parque = new Objetos(fotoParque, width/1.5, 2*height/4, width/1.8, (width/3.5) * 3/2);
		...
		this.elipse = new Objetos(mascoteAtende, width/5.5, height/2.8, width/3.5, width/3.5);
		this.linhas = [];
		this.linhas.push(new Objetos(linhasTelefone, width/5.5, height/1.5, width/3.5, (width/3.5) * 8/53));
		this.linhas.push(new Objetos(linhasInstagram, width/5.5, height/1.3, width/3.5, (width/3.5) * 8/53));
		this.linhas.push(new Objetos(linhasProParreao, width/5.5, height/1.15, width/3.5, (width/3.5) * 8/53));
